...
let usually_Top  = document.getElementsByClassName("top")
...
const registerTimeOfUsually = () => {
    ...
    let name_Ranking = "Lucas";
    let paragraph_Time = stopWatch();
    let paragraph_Ranking = document.createElement("span");
    
    usually_Top[1].innerHTML = " " + name_Ranking + ": " + paragraph_Time;
    ranking_Top.appendChild(paragraph_Ranking);
